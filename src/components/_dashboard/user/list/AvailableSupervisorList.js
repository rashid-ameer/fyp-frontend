...
import { UserListHead, UserListToolbar, CommitteeMoreMenu } from '.';
...
export default function AvailableSupervisorList({ roleList, setRoleList }) {
  ...
  return (
    <Page title="Committee: Available Supervisor | SIBAU FYPMS ">
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <CommitteeMoreMenu onDelete={() => handleDeleteCommittee(row.id)} userName={row.name} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
