...
const TABLE_HEAD = [
  { id: 'committeeCode', label: 'Title', alignRight: false },
  { id: 'moderator', label: 'Supervisor', alignRight: false },
  { id: 'member', label: 'Batch', alignRight: false },
  { id: '' }
];
...
export default function CommitteeList() {
  ...
  const [roleList, setRoleList] = useState([
    { id: '13345', committeeCode: 'Ai Assitant', moderator: 'Dr.Sheer Muhammad', member: '2019' },
    { id: '13346', committeeCode: 'Ai Trading Bot', moderator: 'Dr.Saif', member: '2021' },
    {
      id: '13347',
      committeeCode: 'Web Based Final Year Management System',
      moderator: 'Khalid Hussain',
      member: '2022'
    },
    { id: '13348', committeeCode: 'Ai Based Fire Detector', moderator: 'Dr.Saif', member: '2020' }
  ]);
  ...
  return (
    <Page title="Developed Projects: List | SIBAU FYPMS ">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading="Developed Projects"
          links={[{ name: 'Dashboard', href: PATH_DASHBOARD.root }, { name: 'Projects' }]}
        />
